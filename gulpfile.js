var gulp       = require('gulp'), // Подключаем Gulp
	...
	cache        = require('gulp-cache'), // Подключаем библиотеку кеширования/чтобы картинки кешировались
	...
	sourcemaps = require('gulp-sourcemaps'); //Отображает в консоле реальную структуру файлов
...
gulp.task('clean', function() {
  return del.sync('dist/**/*'); // Удаляем содержимое папки dist
});
...
gulp.task('build', ['clean', 'img', 'sass', 'scripts'], function() {
	...
	var buildSass = gulp.src('app/scss/**/*') // Переносим папку Scss в продакшен
